...
VT = {v: k for k, v in list(vars().items()) if k[:3] == "VT_"}
#
# --------------------------------------------------------------------
...
class OleFileIO:
    ...
    def open(self, filename):
        ...
        self.fp = open(filename, "rb") if isPath(filename) else filename
    ...
    def loadfat(self, header):
        ...
        for i in range(0, len(sect), 4):
            ix = i32(sect, i)
            if ix in [-2, -1]: # ix == 0xFFFFFFFEL or ix == 0xFFFFFFFFL:
                break
            s = self.getsect(ix)
            fat += [i32(s, i) for i in range(0, len(s), 4)]
        self.fat = fat
